...
public class HotelService {
	...
	private static CategoryService categoryService = CategoryService.getCategoryService();
	...
	public void ensureTestData() {
		if (findAll().isEmpty()) {
			final String[] names = new String[] { 
					"Orbita Mira_str267-47 5 +375298886655 +375298886655 www.booking.com someDescription",
					"Gorizont Nemiga_str277-57 5 +375298789966 +375298789966 www.booking.com someDescription",
					"Planeta Orlovskaya_str327-37 2 +375297485533 +375298789966 www.booking.com someDescription",
					"Europa Nezavisemosty_str927-13 5 +735293325665 +735293325665 www.booking.com someDescription",
					"Mars Kulman_str827-45 4 +375294562255 +375294562255 www.booking.com someDescription",
					"Snikers Latera_str327-88 4 +375298843232 +375298843232 www.booking.com someDescription",
					"Apple Pushkina_str257-113 3 +375294456678 +375294456678 www.booking.com someDescription",
					"Zamok Mira_str327-127 3 +375294433225 +375294433225 www.booking.com someDescription",
					};
			...
			for (String name : names) {
				...
				currentHotel.setStarRating(Integer.valueOf(split[2]));
				currentHotel.setPhone(split[3]);
				currentHotel.setFax(split[4]);		
				currentHotel.setCategory( categoryService.findAll().get(random.nextInt(categoryService.findAll().size())));
